...
- `tests/master`: ACR parsing, ACR token cache lifecycle, execution client authorization, gateway errors, method enforcement, request ID propagation, dispatcher errors, worker draining, scheduler capacity/state filtering.
