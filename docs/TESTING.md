...
- `tests/worker`: WASM engine execution, module digest verification and error classification, cache lifecycle, metrics, worker limits including shutdown defaults, worker health/readiness, method enforcement, JSON error handling.
